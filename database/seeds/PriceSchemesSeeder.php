...
class PriceSchemesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->createPrice(1, 20, 20, 1, 'credits', 'Credits buy price N.1');
        $this->createPrice(2, 60, 55, 3, 'credits', 'Credits buy price N.2');
        $this->createPrice(3, 100, 90, 5, 'credits', 'Credits buy price N.3');
        $this->createPrice(1, 20, 20, 1, 'vouchers', 'Voucher buy price N.1');
        $this->createPrice(2, 60, 55, 3, 'vouchers', 'Voucher buy price N.2');
        $this->createPrice(3, 100, 90, 5, 'vouchers', 'Voucher buy price N.3');
