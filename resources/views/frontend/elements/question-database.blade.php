<div class="foundry_modal text-center">
    ...
    <div class="image-upload">
        ...
        <div class="image-actions right">
            ...
            <a href="#" class="btn image-button remove" onclick="clearImage('question-form2', event, '{{ action('UserController@clearImage') }}', '{{ csrf_token() }}', '{{ url()->to('/').'/images/avatars/no_image.png' }}');"><i class="ti-trash"></i> remove</a>
        </div>
        <div class="clear"></div>
    </div>
    ...
    <div class="textarea-holder">
        {!! Form::textarea('question', $question->question ? $question->question : null, ['class' => $errors->question->first('question', 'field-error ').'mt-1px', 'placeholder' => 'What would you like to ask?', 'onKeyPress' => 'countChar(this,event)', 'onKeyUp' => 'countChar(this,event)']) !!}
        <div class="charNum">
            {{ $question->question ? 250 - strlen($question->question) : 250 }}
        </div>
    </div>
    <div class="double-column">
        <a href="#" class="btn question-btn" onclick="clearForm('question-form2', event, '{{ action('UserController@clearQuestion') }}', '{{ csrf_token() }}', '{{ url()->to('/').'/images/avatars/no_image.png' }}');">Clear</a>
